...
void loop() {
  ...
  M5Canvas debug(&M5Cardputer.Display);
  debug.createSprite(140,96);
  debug.print(data);
  debug.println("Data: "+ Buffer.getDataStr());
  debug.println("Nav char: " + String(Buffer.navChar));
  debug.pushSprite(50,30);
  debug.deleteSprite();*/
